...
import { useLocaleText, useUtils, validateDate } from '@mui/x-date-pickers/internals';
import { useDesktopPicker } from '@mui/x-date-pickers/internals/hooks/useDesktopPicker';
import { CalendarIcon } from '@mui/x-date-pickers/icons';
import { DateField } from '../DateField';
import { extractValidationProps } from '@mui/x-date-pickers/internals/utils/validation/extractValidationProps';
...
const DesktopDatePicker = /*#__PURE__*/ React.forwardRef(function DesktopDatePicker(inProps, ref) {
  ...
  const props = _extends({}, defaultizedProps, {
    ...
    yearsPerRow:
      (_defaultizedProps$yea = defaultizedProps.yearsPerRow) != null ? _defaultizedProps$yea : 4,
    slots: _extends(
      {
    ...
    slotProps: _extends({}, defaultizedProps.slotProps, {
      field: (ownerState) => {
        ...
        return _extends(
          ...
          resolveComponentProps(
            (_defaultizedProps$slo = defaultizedProps.slotProps) == null
              ? void 0
      ...
      toolbar: _extends(
        ...
        (_defaultizedProps$slo2 = defaultizedProps.slotProps) == null
          ? void 0
  ...
  const { renderPicker } = useDesktopPicker({
    ...
    getOpenDialogAriaText:
      (_props$localeText$ope =
        (_props$localeText = props.localeText) == null
          ? void 0
          : _props$localeText.openDatePickerDialogue) != null
        ? _props$localeText$ope
