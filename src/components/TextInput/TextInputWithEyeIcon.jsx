 ...
 */
const TextInputWithEyeIcon = memo(
      ...
      <div className={`flex flex-col gap-1 ${divClasses}`}>
        ...
        >
          <input
            ...
            {...props}
          />
          <button onClick={() => setShow(!show)}>{show ? <EyeIcon /> : <EyeOffIcon />}</button>
        </div>
...
TextInputWithEyeIcon.propTypes = {
...
export default TextInputWithEyeIcon;
