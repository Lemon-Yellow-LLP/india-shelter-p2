export const fieldLabels = {
  ...
  permanent_flat_no_building_name: 'Additional Flat no/Building name',
  permanent_street_area_locality: 'Additional Street/Area/Locality',
  permanent_town: 'Additional Town',
  permanent_landmark: 'Additional Landmark',
  permanent_pincode: 'Additional Pincode',
  permanent_city: 'Additional City',
  permanent_state: 'Additional State',
  permanent_no_of_year_residing: 'Additional No. of Year Residing',
  permanent_address_same_as_current: ' Additional address is same as Current address',
